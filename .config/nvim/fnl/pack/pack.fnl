...
(local vimwiki_cmds [:VimwikiMakeDiaryNote
                     :VimwikiDiaryIndex
                     :VimwikiIndex])
...
;; git
(use-package! :TimUntersberger/neogit {:config (load-file :neogit)
                                       :cmd :Neogit
                                       :requires [(pack :sindrets/diffview.nvim {:after :neogit 
                                                                                 :module :diffview 
...
(comment (use-package! :rcarriga/nvim-notify {:opt true
                                              :setup (fn []
                                                       (set vim.notify
                                                            (fn [msg level opts]
...
(use-package! :vimwiki/vimwiki {:cmd vimwiki_cmds})

(use-package! :mcchrish/zenbones.nvim 
              {:requires [(pack :rktjmp/lush.nvim 
                                {:module :lush
                                 :config (call-setup :lush)})]})
...
(use-package! :lukas-reineke/indent-blankline.nvim 
              {:module :indent-blankline
               :config (call-setup :indent-blankline 
...
(use-package! :sheerun/vim-polyglot)
